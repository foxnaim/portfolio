...
const portfolioLocales = {
  ru: {
    ...
    static: {
      ...
      footerLinks: ["Проекты", "Журнал", "GitHub", "Instagram"], motion: ["Пауза", "Смотреть"],
      mobileTitle: "foxnaim / меню", mobileNav: ["Главная", "Пакеты и цены", "Проекты", "Решения", "Журнал", "Обо мне", "Контакт"], mobileProcess: "Этапы и условия",
      ...
      workButtons: ["Открыть весь каталог", "Готовые решения", "Как проходит работа"],
  ...
  en: {
    ...
    static: {
      ...
      footerLinks: ["Projects", "Journal", "GitHub", "Instagram"], motion: ["Pause", "Play"], mobileTitle: "foxnaim / menu", mobileNav: ["Home", "Packages & prices", "Projects", "Solutions", "Journal", "About", "Contact"], mobileProcess: "Process and terms",
      ...
      workFine: "The home page shows a short selection. The full catalog contains the remaining solutions, descriptions and links.", workButtons: ["Open full catalog", "Ready solution patterns", "How the work runs"],
