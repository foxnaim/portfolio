...
const portfolioLocales = {
  ru: {
    ...
    static: {
      skip: "К содержанию", nav: ["Пакеты", "Проекты", "Обо мне", "Контакт"], headerCta: "Обсудить задачу",
      ...
      heroActions: ["Получить план и оценку", "Смотреть работы"], proofValues: ["от 150 000 ₸", "1–8 недель", "30 / 40 / 30", "59"], proof: ["стартовый формат", "срок проекта", "оплата по этапам", "публичных репозиториев"],
      selectorLink: "Форматы, сроки и цены",
      ...
      footerLinks: ["Пакеты", "Решения", "Demo Lab", "Журнал", "GitHub", "Instagram", "Канал"], motion: ["Пауза", "Смотреть"],
      mobileTitle: "foxnaim / меню", mobileNav: ["Главная", "Пакеты и цены", "Проекты", "Решения", "Demo Lab", "Чек-листы", "Журнал", "Обо мне", "Партнёрам", "Контакт"], mobileProcess: "Этапы и условия",
      ...
      workIntro: "Здесь пять сильных примеров «задача → решение». В полном каталоге — бизнес-системы, AI, SaaS, приложения и эксперименты; в GitHub уже 59 публичных репозиториев с кодом.",
      ...
      workButtons: ["Открыть весь каталог", "Готовые решения", "Попробовать Demo Lab", "Журнал разработки", "Как проходит работа"],
      ...
      timeOptions: ["1–2 недели", "3–5 недель", "До 2 месяцев", "Без жёсткого срока"], resultKicker: "Подходящий старт", scopeTitle: "Состав первой версии", resultActions: ["Посмотреть состав", "Подготовить сообщение"], estimateLabels: ["Ориентир по бюджету", "Ориентир по сроку"], selectorNote: "Диапазон предварительный. Точная оценка появляется после короткого брифа; ответы остаются только в браузере.",
      contactTop: "Принимаю новые запросы", contactTitle: "Сначала план.<br><span>Потом разработка.</span>", contactIntro: "Опишите задачу своими словами. Я помогу определить первую версию, ориентир по сроку и бюджету — техническое задание не требуется.", briefLabel: "Пара слов о вашем проекте", optional: "необязательно", placeholder: "Хочу сайт для… / Нужна система, которая…", contactAssurances: ["Оплата по этапам 30 / 40 / 30", "Рабочая демонстрация после этапа", "Исходный код и доступы передаются", "Можно начать без готового ТЗ"], contactButtons: ["Скопировать бриф и открыть Instagram", "Build with Yan", "Только скопировать"], contactAvailability: "Ближайший старт согласуем после короткого брифа.", formNote: "Текст остаётся в этом окне и копируется только по вашему действию. Сайт не отправляет содержание формы автоматически."
    },
    services: {
    ...
    selector: {
      recommendations: {
        web: { label: "Сайт или интернет-магазин", description: "Начать стоит со структуры предложения и одного главного пути: от первого экрана до заявки или покупки.", page: "services/web-development/", budget: "150 000–300 000 ₸", timeline: "1–2 недели", brief: "сайт, каталог или интернет-магазин", scope: ["Структура и основной пользовательский путь", "Адаптивный интерфейс", "Форма заявки или корзина", "Базовая аналитика и техническое SEO"] },
        crm: { label: "CRM, кабинет или SaaS", description: "Первая версия должна собрать роли, данные, статусы и одно действие, которое сейчас отнимает больше всего времени.", page: "services/crm-development/", budget: "от 800 000 ₸", timeline: "4–8 недель", brief: "CRM, личный кабинет или SaaS-систему", scope: ["Роли и права", "Основные сущности и статусы", "История действий", "Один полезный отчёт"] },
        ai: { label: "AI-автоматизация или Telegram-бот", description: "Лучший старт — один повторяющийся сценарий на реальных примерах с логами и возможностью ручного контроля.", page: "services/ai-automation/", budget: "от 200 000 ₸", timeline: "1–5 недель", brief: "AI-автоматизацию, интеграцию или Telegram-бота", scope: ["Один повторяющийся сценарий", "Реальные входные примеры", "Логи и обработка ошибок", "Ручное подтверждение важных действий"] },
        mvp: { label: "Рабочий MVP", description: "Нужно выделить основную гипотезу и собрать минимальный путь пользователя с интерфейсом, данными и критериями готовности.", page: "services/product-development/", budget: "450 000–900 000 ₸", timeline: "3–5 недель", brief: "первую версию нового продукта", scope: ["Главная гипотеза", "Один полный путь пользователя", "Интерфейс, API и данные", "Критерии готовности и обратная связь"] }
      },
  ...
  en: {
    ...
    static: {
      skip: "Skip to content", nav: ["Packages", "Projects", "About", "Contact"], headerCta: "Discuss a task",
      ...
      heroActions: ["Get a plan and estimate", "View work"], proofValues: ["from KZT 150,000", "1–8 weeks", "30 / 40 / 30", "59"], proof: ["starting format", "project range", "staged payments", "public repositories"], selectorLink: "Packages, timelines and prices",
      ...
      workFine: "The home page shows a short selection. The full catalog contains the remaining solutions, descriptions and links.", workButtons: ["Open full catalog", "Ready solution patterns", "Try Demo Lab", "Development journal", "How the work runs"],
    ...
    selector: {
      recommendations: {
        web: { label: "Website or online store", description: "Start with the offer structure and one complete path from the first screen to a lead or purchase.", page: "services/web-development/", budget: "KZT 150,000–300,000", timeline: "1–2 weeks", brief: "a website, catalog or online store", scope: ["Structure and primary user flow", "Responsive interface", "Lead form or cart", "Basic analytics and technical SEO"] },
        crm: { label: "CRM, dashboard or SaaS", description: "The first version should combine roles, data, statuses and the action that currently consumes the most time.", page: "services/crm-development/", budget: "from KZT 800,000", timeline: "4–8 weeks", brief: "a CRM, dashboard or SaaS system", scope: ["Roles and permissions", "Core records and statuses", "Action history", "One useful report"] },
  ...
  kk: {
    ...
    static: {
      skip: "Негізгі мазмұнға өту", nav: ["Пакеттер", "Жобалар", "Мен туралы", "Байланыс"], headerCta: "Тапсырманы талқылау",
      availability: "Жаңа жобаларға ашық", headline: ["Сіздің идеяңыз.", "Менің келесі жобам."], subhead: "Бизнеске арналған сайттар, CRM және AI автоматтандыру жасаймын.<br class=\"desktop-break\"> Өтінім алуға және уақыт үнемдеуге көмектесемін.", heroActions: ["Жоспар мен баға алу", "Жұмыстарды көру"], proofValues: ["150 000 ₸ бастап", "1–8 апта", "30 / 40 / 30", "59"], proof: ["бастапқы формат", "жоба мерзімі", "кезеңдік төлем", "ашық репозиторий"], selectorLink: "Форматтар, мерзімдер және бағалар",
      services: [["Сайттар мен дүкендер", "Лендингтер, каталогтар және e-commerce"], ["CRM және SaaS", "Кабинеттер, рөлдер және процестер"], ["AI және автоматтандыру", "AI көмекшілер, Telegram және API"], ["Толық MVP", "Прототип, әзірлеу және іске қосу"]], footerLinks: ["Пакеттер", "Шешімдер", "Demo Lab", "Журнал", "GitHub", "Instagram", "Арна"], motion: ["Тоқтату", "Қосу"], mobileTitle: "foxnaim / мәзір", mobileNav: ["Басты бет", "Пакеттер мен бағалар", "Жобалар", "Шешімдер", "Demo Lab", "Чек-листтер", "Журнал", "Мен туралы", "Серіктестерге", "Байланыс"], mobileProcess: "Кезеңдер мен шарттар",
      workKicker: "Кодын көруге болатын жобалар", workTitle: "Жұмыс істейтін өнімдер.<br><span>Адал белгіленген прототиптер.</span>", workLink: "Жобалар беті", workIntro: "Мұнда «міндет → шешім» форматы бойынша бес мысал бар. Толық каталогта бизнес жүйелері, AI, SaaS, қолданбалар және эксперименттер жинақталған; GitHub-та 59 ашық репозиторий бар.", workProof: ["таңдалған кейс", "каталогта", "код репозиторийі"], projectCopy: ["Өтінімдерді жіктеу, lead score және келесі әрекетті ұсынуға арналған интерактивті frontend концепті.", "Telegram және QR-код арқылы жұмыс уақытын есептеу, команда аналитикасы және фрилансер таймері.", "Іздеу, тегтер және болашақ AI функцияларының интерфейстері бар жазбалар мен тапсырмалар кеңістігі.", "Қызметтер, кесте, шағын CRM және әкімші кабинеті бар онлайн жазылу макеті.", "Каталог, себет, тапсырыс рәсімдеу және тарихы бар Telegram-дүкен макеті."], workFine: "Басты бетте қысқа таңдау көрсетілген. Қалған шешімдер, сипаттамалар және сілтемелер толық каталогта.", workButtons: ["Толық каталогты ашу", "Дайын шешімдер", "Demo Lab-ты көру", "Әзірлеу журналы", "Жұмыс барысы"],
    ...
    selector: {
      recommendations: {
        web: { label: "Сайт немесе интернет-дүкен", description: "Ұсыныс құрылымынан және алғашқы экраннан өтінімге не сатып алуға дейінгі бір толық жолдан бастаған дұрыс.", page: "services/web-development/", budget: "150 000–300 000 ₸", timeline: "1–2 апта", brief: "сайт, каталог немесе интернет-дүкен", scope: ["Құрылым және негізгі пайдаланушы жолы", "Бейімделетін интерфейс", "Өтінім формасы немесе себет", "Базалық аналитика және техникалық SEO"] },
        crm: { label: "CRM, кабинет немесе SaaS", description: "Алғашқы нұсқа рөлдерді, деректерді, мәртебелерді және ең көп уақыт алатын әрекетті біріктіруі керек.", page: "services/crm-development/", budget: "800 000 ₸ бастап", timeline: "4–8 апта", brief: "CRM, кабинет немесе SaaS жүйесін", scope: ["Рөлдер мен құқықтар", "Негізгі жазбалар мен мәртебелер", "Әрекеттер тарихы", "Бір пайдалы есеп"] },
...
function applyLanguage(locale, updateUrl = true) {
  ...
  applyArray(".hero-proof strong", copy.proofValues);
  ...
  applyArray("#selector .selector-estimate small", copy.estimateLabels);
  ...
  applyArray("#contact .contact-assurances li", copy.contactAssurances);
  applyArray("#contact .contact-actions > *", copy.contactButtons, leadingText);
  text("#contact .contact-availability", copy.contactAvailability);
