...
const portfolioLocales = {
  ru: {
    ...
    static: {
      ...
      heroActions: ["Получить план и оценку", "Смотреть работы"], proofValues: ["от 150 000 ₸", "1–8 недель", "30 / 40 / 30", "58"], proof: ["стартовый формат", "срок проекта", "оплата по этапам", "публичных репозиториев"],
      ...
      footerLinks: ["Пакеты", "Решения", "Demo Lab", "GitHub", "Instagram", "Канал"], motion: ["Пауза", "Смотреть"],
      mobileTitle: "foxnaim / меню", mobileNav: ["Главная", "Пакеты и цены", "Проекты", "Решения", "Demo Lab", "Чек-листы", "Обо мне", "Партнёрам", "Контакт"], mobileProcess: "Этапы и условия",
      ...
      workIntro: "Здесь пять сильных примеров «задача → решение». В полном каталоге — бизнес-системы, AI, SaaS, приложения и эксперименты; в GitHub уже 58 публичных репозиториев с кодом.",
  ...
  en: {
    ...
    static: {
      ...
      heroActions: ["Get a plan and estimate", "View work"], proofValues: ["from KZT 150,000", "1–8 weeks", "30 / 40 / 30", "58"], proof: ["starting format", "project range", "staged payments", "public repositories"], selectorLink: "Packages, timelines and prices",
