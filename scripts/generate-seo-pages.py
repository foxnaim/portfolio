...
PAGES = {
    "services/web-development": {
        "kind": "Услуга 01",
        "title": "Разработка сайтов для бизнеса — foxnaim",
    ...
    "services/crm-development": {
        "kind": "Услуга 02",
        "title": "Разработка CRM и SaaS-сервисов — foxnaim",
    ...
    "services/ai-automation": {
        "kind": "Услуга 03",
        "title": "AI-автоматизация и Telegram-боты для бизнеса — foxnaim",
        "description": "AI-помощники, Telegram-боты и API-интеграции для обработки заявок, поиска по документам и сокращения ручной работы.",
        ...
        "deliverables": ["Telegram-боты", "AI-помощники", "Поиск по документам", "Обработка обращений", "API-интеграции", "Уведомления и отчёты"],
        "faq": [
    ...
    "services/product-development": {
        "kind": "Услуга 04",
        "title": "Разработка MVP: от идеи до запуска — foxnaim",
...
ABOUT = {
    "title": "Full-stack разработчик foxnaim — обо мне",
    "description": "Full-stack разработчик: сайты, CRM, SaaS и AI-автоматизация на TypeScript, React, Next.js, Node.js и NestJS.",
    "h1": "От интерфейса до API — один ответственный разработчик.",
    "lead": "Я foxnaim, independent full-stack developer. Помогаю превратить идею в работающий цифровой продукт и беру на себя клиентскую часть, сервер, данные и интеграции.",
    "keywords": "full-stack разработчик, frontend разработчик, backend разработчик, TypeScript, React, Next.js, NestJS, foxnaim",
}

CONTACT = {
    "title": "Обсудить разработку сайта, CRM или AI — foxnaim",
    "description": "Расскажите о задаче: сайт, CRM, SaaS, Telegram-бот или AI-автоматизация. Связь с full-stack разработчиком foxnaim через Instagram.",
    ...
    "keywords": "заказать сайт, заказать CRM, разработчик на проект, заказать Telegram бота, разработка SaaS, foxnaim контакты",
}
...
def schema_base(url, title, description):
    return {
        ...
        "@graph": [
            ...
            {"@type": "Person", "@id": abs_url() + "#person", "name": BRAND, "url": abs_url(), "image": abs_url("assets/portrait.png"), "sameAs": [CONFIG["github"], CONFIG["instagram"]], "jobTitle": "Full-stack разработчик", "knowsAbout": ["TypeScript", "React", "Next.js", "Node.js", "NestJS", "CRM", "SaaS", "AI automation"]},
...
def footer(depth):
    root = rel_root(depth)
    return f'''<footer class="seo-footer"><span>© {date.today().year} {BRAND}</span><div><a href="{root}">Главная</a><a href="{CONFIG['github']}" rel="noopener">GitHub</a><a href="{CONFIG['instagram']}" rel="noopener">Instagram</a></div></footer>'''
...
def projects_page():
    ...
    title = "Проекты: сайты, SaaS и web-приложения — foxnaim"
    description = "Избранные full-stack проекты foxnaim: Tact, NeuroNotes, Dev-flow и feed Back. Задачи, реализованные сценарии и технологии."
...
def main():
    ...
    write("about/index.html", simple_page("about", ABOUT, '''<section class="seo-profile" aria-label="Профиль разработчика"><img src="../assets/portrait.png" width="160" height="160" loading="lazy" decoding="async" alt="Фото разработчика foxnaim"><div><p class="seo-kicker">Independent developer</p><h2>foxnaim</h2><p>Код — на GitHub. Процесс и связь — в Instagram.</p></div></section><section class="seo-section"><h2>Работаю с продуктом целиком</h2><div class="seo-grid"><article class="seo-card"><span class="number">01</span><h3>Frontend</h3><p>Адаптивные интерфейсы на React и Next.js, понятные сценарии и внимание к скорости.</p></article><article class="seo-card"><span class="number">02</span><h3>Backend</h3><p>API на Node.js и NestJS, базы данных, авторизация, роли и бизнес-логика.</p></article><article class="seo-card"><span class="number">03</span><h3>Интеграции</h3><p>Telegram, внешние API, AI-сервисы, уведомления и автоматизация процессов.</p></article></div></section><section class="seo-section"><h2>Основной стек</h2><ul class="seo-list"><li>TypeScript и JavaScript</li><li>React и Next.js</li><li>Node.js и NestJS</li><li>PostgreSQL и MongoDB</li><li>REST API и WebSocket</li><li>Docker и GitHub Actions</li></ul><a class="seo-button primary" href="../contact/">Обсудить проект</a></section>'''))
    write("contact/index.html", simple_page("contact", CONTACT, f'''<section class="seo-section"><h2>Что написать в первом сообщении</h2><ul class="seo-list"><li>Чем занимается ваш бизнес или продукт</li><li>Какую задачу нужно решить</li><li>Кто будет пользоваться решением</li><li>Какие сервисы уже используются</li></ul><div class="seo-actions"><a class="seo-button primary" href="{CONFIG['instagram']}" rel="noopener">Написать в Instagram</a><a class="seo-button" href="{CONFIG['github']}" rel="noopener">Открыть GitHub</a></div></section><section class="seo-section seo-faq"><h2>Перед началом</h2><details open><summary>Нужно ли готовое техническое задание?</summary><p>Нет. Достаточно своими словами описать проблему и желаемый результат. Структуру и технические детали можно определить вместе.</p></details><details><summary>Как формируются сроки и стоимость?</summary><p>После короткого брифа задача делится на этапы. Оценка зависит от состава функций, интеграций и готовности контента.</p></details></section>'''))
